...
public class DefaultBitManipulation {
	
	public static void main(String[] args) {
		
		DefaultBitManipulation obj = new DefaultBitManipulation();		
		System.out.println(obj.exec(new int[] {2,2,1}));
